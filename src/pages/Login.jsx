    ...
    <main className="login-page" role="main">
      ...
      <div className="login-card-wrapper">
        ...
        <div className="login-header">
          ...
          <h1 className="login-title">{isSignUp ? 'Create an Account' : 'Sign In'}</h1>
        ...
        <form className="login-form" onSubmit={handleEmailAuthSubmit}>
          ...
          <button
            type="submit"
            className="submit-btn-glass login-submit-btn"
        ...
        {/* Action Buttons: Google + Demo Guest */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <button
            type="button"
            className="google-btn-glass login-google-btn"
          ...
          <button
            type="button"
            className="demo-btn-glass login-demo-btn"
