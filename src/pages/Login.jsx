    ...
    <div className="login-page">
      ...
      <div className="login-card-wrapper">
        <Glass 
          ...
          radius={24}
          optics={{
            frost: 0.5, // Changed from 12 to 0.5 for extreme clarity
            dispersion: 0.5, // Higher chromatic aberration
            curvature: 0.6, // Magnifying dome effect
            bend: 0.2, // Subtle rim refraction
            depth: 0.7,
            glow: 0.15
          }}
        >
        ...
        <form className="login-form" onSubmit={handleEmailAuthSubmit}>
          {isSignUp && (
            <div className="input-group">
              <Glass className="input-wrapper" radius={12} optics={innerOptics}>
          ...
          <Glass className="submit-btn-glass" radius={12} optics={innerOptics}>
            <button
              type="submit"
        ...
        {/* Google Sign In */}
        <Glass className="google-btn-glass" radius={12} optics={innerOptics}>
          <button
